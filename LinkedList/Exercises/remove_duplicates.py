    ...
    def remove_duplicates(self):
        ...
        while current_node is not None:
            if current_node.value in values:
                # current_node = current_node.next # = 1.next => current node = 4
                prev.next = current_node.next  # = 3.next = 1.next => 3.next =>4
                current_node.next = None  # 1.next = 4
                current_node = prev.next  # current node = 4
                self.length -= 1
            else:
