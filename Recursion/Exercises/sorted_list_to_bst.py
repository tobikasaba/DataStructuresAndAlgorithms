...
class BinarySearchTree:
    ...
    def __sorted_list_to_bst(self, nums, left, right):
        ...
        current_node = Node(nums[mid_point])

        current_node.left = self.__sorted_list_to_bst(nums, left, mid_point - 1)
        current_node.right = self.__sorted_list_to_bst(nums, mid_point + 1, right)
        return current_node
